...
const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/bbyoinsider/",
...
export function Footer() {
  return (
    <footer className="mt-auto bg-[#e42158] text-white">
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          ...
          <div className="flex flex-col items-start">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 text-sm text-[#fbdbe4] transition-colors hover:text-white"
            >
              bbyo.org
            </a>
          </div>
